...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "OR", "AND",
  "XOR", "NOT", "LPAREN", "RPAREN", "INVALID", "$accept", "input", "E",
  "T", "F", YY_NULLPTR
};
...
{
       9,    12,     1,    13,    16,    17,     2,     3,    12,     4,
      13,    11,    18,    15,    14,    10
};

static const yytype_int8 yycheck[] =
{
       2,     4,     3,     6,    12,    13,     7,     8,     4,    10,
       6,     0,    14,     9,     5,     3
};
...
{
       0,     3,     7,     8,    10,    12,    13,    14,    15,    15,
      13,     0,     4,     6,     5,     9,    14,    14,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: E  */
#line 36 "Assignment10.y"
        { finalTree = (yyvsp[0].node); }
#line 1158 "y.tab.c"
    break;

  case 3: /* E: E OR T  */
#line 41 "Assignment10.y"
        {
...
#line 1221 "y.tab.c"
  ...
  case 10: /* F: ID  */
#line 82 "Assignment10.y"
        {
            printf("Reducing by: F → id\n");
            (yyval.node) = makeNode("id", NULL, NULL);
        }
#line 1230 "y.tab.c"
    break;

  case 11: /* F: INVALID  */
#line 87 "Assignment10.y"
        {
