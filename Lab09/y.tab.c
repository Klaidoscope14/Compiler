...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* E: E '+' T  */
#line 40 "Assignment9.y"
{
        printf("Reducing by: E -> E + T\n");
        (yyval.node) = createNodeWithChildren("+", (yyvsp[-2].node), (yyvsp[0].node));
...
#line 1218 "y.tab.c"
  ...
  case 9: /* F: '-' F  */
#line 93 "Assignment9.y"
 {
        printf("Reducing by: F -> - F\n");
        (yyval.node) = createNodeWithChildren("-", NULL, (yyvsp[0].node));
        printTree((yyval.node), 0);
        printf("-----------------------\n");
    }
#line 1229 "y.tab.c"
